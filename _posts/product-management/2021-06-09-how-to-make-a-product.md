...
有些企业会通过正式的市场需求文档（MRD）和产品需求文档（PRD）来传达这些信息（比如[行程规划旅游APP—市场需求文档（MRD）](http://www.woshipm.com/evaluating/921572.html)），有些则采用更轻量级的方式（比如需求列表）来管理。总之，有了这些说明性的产品文档的支持，在产品的研发阶段我们便可以有效地与设计和开发人员沟通产品的需求。
