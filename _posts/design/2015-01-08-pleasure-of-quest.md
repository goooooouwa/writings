...
![overflow](https://goooooouwa.oss-cn-beijing.aliyuncs.com/img/xobg0KZ.png)
...
![overflow](https://goooooouwa.oss-cn-beijing.aliyuncs.com/img/62FzHGF.png)
...
![overflow](https://goooooouwa.oss-cn-beijing.aliyuncs.com/img/OJP6K7u.png)

上半部分是好友列表，下半部分是人脉圈列表。用户通过拖拽好友至人脉圈上然后释放，即可将此好友加入此人脉圈。这种设计正是我所寻找的“功能强大、简单好用”的方案。于是我开始动手将其实现。

![overflow](https://goooooouwa.oss-cn-beijing.aliyuncs.com/img/AOfUxLi.png)
