...
- [Use Cloudflare as DNS provider](https://github.com/acmesh-official/acme.sh/wiki/dnsapi#dns_cf)
...
### Step 2: 使用 FREEDNS or Cloudflare 的DNS验证方式申请 SSL 证书


FreeDNS (doesn't support subdomains)
```
