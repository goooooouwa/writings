...
Download the example [here]({{ "/assets/download/2014-12-12-how-to-preserve-the-format-of-my-code-while-posting-in-keynote/example_HTML_converted_from_source_code.html" | relative_url }}){: download="example-html" }.