...
在博客的迭代过程中，我尝试优化的最多的就是作为作者的发布工作流。毕竟我是使用博客最多的用户。
...
而[prose.io](http://prose.io/)完美的解决了这个问题，让随时随地一键发布博客成为了可能。
...
既然是一个博客，读者的需求也是需要考虑的。好在目前访问的人数不多，基本的功能可用即可。用户数少还有一个好处是，我可以随时进行一些破坏性的改动（比如替换评论工具）。
