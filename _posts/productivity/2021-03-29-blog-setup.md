...
大学期间我开始有了一些写作的需求，因此希望有一个自己的博客来发布写作的内容。从2010年开始，我先后使用过Google Blogger、Tumblr、Medium作为自己的博客，可是在使用一段时间之后，当我想将博客文章迁移到其他博客平台时，我发现这些博客平台普遍存在几个令我很头疼的问题：
...
Google Custom Search是谷歌提供的站内搜索工具，可以通过[Google Search Console](https://search.google.com/search-console)查看站内链接索引情况，搜索结果的优化相当于同时做了Google SEO。
