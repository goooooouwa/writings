...
**内容独立性**。用户的内容是属于用户的，我的内容应该能够自由地往来不同的内容平台。针对博客系统而言，就是文章导出后不需要手动编辑便可以查看，甚至直接导入其他博客。

而这一点与博客平台的利益是天然相违背的，平台不会主动地支持用户将内容轻松地迁移到其他平台，最多就允许你把内容导出。所以，如果希望做到内容的真正独立，一个绝对可靠的选择就是自己搭建基于文本的博客系统。

那么问题来了，要自己动手搭建博客，一定少不了维护的成本，我理想中的自建博客应该能够：
...
于是2017年下半年，我开始利用业余时间基于Jekyll和Github pages搭建自己的博客。前前后后也已经小步迭代了3年多，主体功能基本都找到了趁手的工具。本文用来记录目前的设定，日后也会更新，希望对有类似需求的小伙伴有参考价值。
