...
**内容独立性**。用户的内容是属于用户的，我的内容应该能够自由地往来不同的内容平台。针对博客系统而言，就是文章导出后不需要额外处理便可以查看，甚至直接导入其他博客。

而这一点与博客平台的利益是相违背的，平台不会主动地帮助用户将内容轻松的迁移到其他平台，最多就是让你导出内容。这就意味着，如果希望做到

如果这样一个博客系统只能靠自己动手搭建的话，我期望不用花费太高的维护成本，能够做到：
