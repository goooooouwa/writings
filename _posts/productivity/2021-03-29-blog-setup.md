...
大学期间我逐渐有了一些写作的需求，包括记录生活、学习笔记，以及一些思考和创作，于是希望有一个自己的博客来保存和分享这些内容。从2010年开始，我先后使用过Google Blogger、Tumblr和Medium作为自己的博客，使用过程中遇到的一个共同的问题就是，每当我为了尝试一个新的平台而进行文章迁移时，都会遇到几个令我十分头疼的问题：

- 导出的文章为HTML文件，内容跟样式混杂在一起，可读性很低
- 我需要将导出的文章手动导入到新的博客系统（或者需要进行一定格式的调整）
- 自己定制过的主题样式相当于浪费了

在使用过这几款流行的博客平台后，我开始对博客有些失望，主要的原因是感到自己的内容被限制在了特定的平台上。
...
至此我才意识到，我对博客（和任何内容平台）有着一个不可妥协的需求：

**内容独立性**。独立性主要体现在两个方面：

1. 内容应该能够自由地往来不同的平台。针对博客系统而言，就是文章可以轻松的从一个博客转移到另一个博客。
1. 内容的使用不依赖于特定平台。针对博客系统而言，就是文章从博客导出后可以直接查看。

以上两点与内容平台的利益是天然相违背的。因此如果希望做到内容的真正独立，依赖任何第三方平台都很难得到保证的。一个绝对可靠的选择是自己搭建博客。
...
于是2017年下半年，我开始利用些业余时间基于Jekyll和Github pages搭建自己的博客。
...
在过去的3年多时间里，我通过学习Jekyll和各种相关工具的使用，在逐渐搭建起博客的主要功能的基础上，不断地尝试和比较各种工具来持续改进功能的用户体验，持续地朝着这3个目标优化着我的博客。本文用来记录目前的设定，日后也会更新，希望对有类似需求的小伙伴有参考价值。
